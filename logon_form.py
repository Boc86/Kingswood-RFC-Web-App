...
### also need to check if the RFU ID is already registered in the logons table and if its recorded within the members table
        ...
        with tab1:
            ...
            if login_button:
                if check_login(login_username, login_password):
                    ...
                    # Set session state for RFU ID and also membership status
                    st.rerun()
                else:
