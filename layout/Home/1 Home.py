...
with st.container():
    ...
    with left_col:
        ...
        st.page_link("layout/Parent Info/1 Parent Info.py", label="Parent Welcome Letter", icon=":material/info:", help=None, disabled=False, use_container_width=None)
        st.page_link("layout/Player Info/1 Player Info.py", label="Player Welcome Letter", icon=":material/info:", help=None, disabled=False, use_container_width=None)
        st.page_link("layout/Home/2.1 Key Personnel.py", label=None, icon=":material/account_circle:", help=None, disabled=False, use_container_width=None)
        ...
        st.page_link("layout/Policies/1 Policies.py", label="Club Polices", icon=":material/topic:", help=None, disabled=False, use_container_width=None)  
