...
body_markdown = read_markdown_file('content/expectations/member commitment/body.md')
intro_markdown = read_markdown_file('content/expectations/member commitment/intro.md')
