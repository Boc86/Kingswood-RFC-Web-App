...
body_markdown = read_markdown_file('content/expectations/spectator commitment/body.md')
intro_markdown = read_markdown_file('content/expectations/spectator commitment/intro.md')
