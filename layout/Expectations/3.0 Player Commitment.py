...
body_markdown = read_markdown_file('content/expectations/player commitment/body.md')
intro_markdown = read_markdown_file('content/expectations/player commitment/intro.md')
