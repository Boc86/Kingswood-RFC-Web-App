...
body_markdown = read_markdown_file('content/expectations/club promise/body.md')
intro_markdown = read_markdown_file('content/expectations/club promise/intro.md')
